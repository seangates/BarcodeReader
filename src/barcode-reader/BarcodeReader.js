...
BarcodeReader = {
  ...
  Init: function() {
    console.log(BarcodeReader.ScanCanvasWidth, BarcodeReader.ScanCanvasHeight);
    BarcodeReader.ScanCanvas = BarcodeReader.FixCanvas(document.createElement("canvas"));
    BarcodeReader.ScanCanvas.width = BarcodeReader.ScanCanvasWidth;
    BarcodeReader.ScanCanvas.height = BarcodeReader.ScanCanvasHeight;
  ...
  SetScanCanvasWidth: function(width) {
    BarcodeReader.ScanCanvasWidth = width;
  },

  SetScanCanvasHeight: function(height) {
    BarcodeReader.ScanCanvasHeight = height;
  },
